...
#define __GLOBALS__
    ...
    #define AMOUNT_OF_LOG_FILES_TO_KEEP 125
        ...
        #define DEFAULT_VPN_INTERFACE_SHUTDOWN_COMMAND "ifconfig tap0 destroy ; ifconfig tap1 destroy"
    #endif
    #ifdef __linux__
        #define DEFAULT_VPN_INTERFACE_SETUP_COMMAND "openvpn --mktun --dev tap0 && openvpn --mktun --dev tap1 && ifconfig tap0 10.20.0.1 netmask 255.255.0.0 && ifconfig tap1 10.21.0.1 netmask 255.255.0.0 && echo 'success'"
        #define DEFAULT_VPN_INTERFACE_SHUTDOWN_COMMAND "ifconfig tap0 down ; ifconfig tap1 down"
    #endif
